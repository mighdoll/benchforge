...
const cliOptions = {
  ...
  "alloc-user-only":{ type: "boolean", default: true, describe: "hide node internals in allocation output (default: on; --no-alloc-user-only to include)" },
  ...
  "profile-user-only":{ type: "boolean", default: true, describe: "hide node internals in CPU profile (default: on; --no-profile-user-only to include)" },
